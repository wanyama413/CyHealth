...
function makeBubbleScatter() {
    ...
    var isPlaying;
    if (!chart) JSC.fetch("https://raw.githubusercontent.com/wanyama413/covid19/main/covidData.csv").then(function(response) {
        ...
        JSC.fetch("https://raw.githubusercontent.com/wanyama413/covid19/main/covidData.csv").then(function(response) {
            return response.text();
        }).then(function(text) {
...
//# sourceMappingURL=index.8bbc5154.js.map
